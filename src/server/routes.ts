...
export function init(app: Express) {
  app.route("/article").post(validateToken, addArticle);
  app.route("/cart").get(validateToken, getCart);

  app.route("/crear").post(crearGusto())
  app.route("/:idUsuario").post(recomendarArticulo())
  app.route("/:idUsuario/:etiqueta").post(noRecomendarPorArticuloRelacionado())
}
